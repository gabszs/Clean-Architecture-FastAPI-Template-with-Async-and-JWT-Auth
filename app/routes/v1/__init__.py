...
from app.routes.v1.user_role_route import router as user_role_router
from app.routes.v1.user_tenant_route import router as user_tenant_router
from app.routes.v1.users_routes import router as user_router

routers = APIRouter(prefix="/v1")
router_list = [auth_router, user_tenant_router, user_role_router, tenant_router, role_route, user_router, ping_router]
