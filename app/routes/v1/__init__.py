...
from app.routes.v1.database_route import router as database_router
from app.routes.v1.history_route import router as history_router
...
router_list = [auth_router, database_router, history_router, tenant_router, role_route, user_router, ping_router]
